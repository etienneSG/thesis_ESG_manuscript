...
\newcommand{\fab}[1]{\todo[color=argon orange!20]{#1}}
...
\newcommand{\fabil}[1]{\todo[inline,color=argon orange!20]{Question pour FAB: #1}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newtheorem*{questionfr}{Question ouverte}
...
%\newcommand{\distrib}{``expanded Dirichlet''}

\newcommand{\bulletplus}{\textcolor{argon orange}{\textcircled{+}}}
\newcommand{\bulletminus}{\textcolor{argon gray}{\textcircled{--}}}
...
% Lot-size models
\newcommand\lines{\cL}              % Set of lines
...
\newcommand\bed{y}                  % 1 if cover  is chosen for the item and 0 otherwise

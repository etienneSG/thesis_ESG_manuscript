...
% Common
\newcommand\REF{\cR}  % Set of product
...
\newcommand\inventory{s}            % Inventory of product at the end of period (may be negative)
\newcommand\backlog{b}              % Backlog quantity of product at end of period
\newcommand\excess{\tilde{s}}       % Excess of inventory of product at the end of period

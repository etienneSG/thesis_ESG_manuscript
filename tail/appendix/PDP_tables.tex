...
The characteristics of each line is given in \cref{sec:PDP:numerical-experiments:historical-data} and the meaning of each column of \crefrange{tab:pdp:results:line-0}{tab:pdp:results:line-6} as well as the way of computing the KPI's are given in \cref{sec:PDP:numerical-experiments:numerical-results}.

...
Stocks, also called \emph{inventory}, are not a cost.
...
Defining its agility depends on the industry but also on decision level: strategic (long-term), tactic (mid-term) or operational (short-term).

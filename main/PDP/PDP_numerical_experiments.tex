...
We also add the loading characteristic $\kappa_t$ at period $t$ defined as follows. it is only used to provides an indication of the hardness of the instance.
\begin{equation}

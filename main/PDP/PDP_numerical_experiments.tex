...
Thus we turn to the formula used in practice by most of Argon Consulting's clients (see \cite[Chapter 11]{Arnold2007}) where the underlying model assumes that demand has a Gaussian distribution.
...
\esgil{Eventually use $k$-medoids algorithm which enables to choose the distance used.}
...
We refer to \cite[Chapter 14]{Hastie2009} for a detailed presentation of the method.

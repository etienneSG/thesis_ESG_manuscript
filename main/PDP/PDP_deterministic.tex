...
Consider the following instance of CLSP-BS:
\begin{equation}
\begin{split}
  \REF=\crbracket{1,2}
  ,\quad
...
We have
\begin{equation}
V_t\bracket{\inventory_t} = \min_{\inventory_{t+1}\in\cS_{t+1}} \crbracket{c_t\bracket{\inventory_t,\inventory_{t+1}} + V_{t+1}\bracket{\inventory_{t+1}}}
\end{equation}
Finally, 
\end{proof}

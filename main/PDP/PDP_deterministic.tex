...
We present in this section different way to solve the CLSP-BS.
...
% Without loss of generality, we assume that there are no initial inventory (\ie $\inventory_0^i=0$, for each item $i$).
...
\esgil{Check backward vs. forward in the literature.}
\esgil{Check the notations used in \citet{Geunes2014}.}



% \esgil{TODO: Finite capacity}

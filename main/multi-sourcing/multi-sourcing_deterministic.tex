...
Thus, Argon Consulting aims at getting a versatile model which can be used in many situations and must\vl{should be not to} not be too dependent on the industry.
...
\right.
$$
Then, we solve the resulting linear program to get the\vl{an} optimal solution of the deterministic multi-sourcing problem.
...
\esgil{WARNING: Case 2 is false! This is an open question! Open everything may lead to infeasibility!}

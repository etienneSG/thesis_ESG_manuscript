...
Second, worst cases must be not ``not too bad''.
...
The goal is to satisfy the service level measure at minimum cost.
...
More, it is already linear making it easy to use.

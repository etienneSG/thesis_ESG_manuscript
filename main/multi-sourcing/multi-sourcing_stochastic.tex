...
\esgil{Add example of the $\AVaR$ with one item and four plants.}
...
\esgil{Add the end of the example with 4 plants and 1 item. DO NOT forget to write each constraint.}

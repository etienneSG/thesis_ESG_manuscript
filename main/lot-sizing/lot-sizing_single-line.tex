...
For each item $i$, there is an initial inventory $\inventory_i\bracket{0}\in\RR_+$ given in input. The notations
...
Conversely, using lot-size variables as first-step variables would lead to use cover-sizes as second-step variable.
